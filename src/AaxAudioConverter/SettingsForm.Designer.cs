namespace audiamus.aaxconv {
  partial class SettingsForm {
    ...
    private void InitializeComponent () {
      ...
      this.ckBoxFfmpegVersCheck = new System.Windows.Forms.CheckBox();
      this.lblFfmpegVersCheck = new System.Windows.Forms.Label();
      ...
      this.lblDateClm = new System.Windows.Forms.Label();
      this.ckBoxDateClm = new System.Windows.Forms.CheckBox();
      ...
      this.lblVarBitRate = new System.Windows.Forms.Label();
      this.lblRedBitRate = new System.Windows.Forms.Label();
      ...
      this.comBoxConductor = new System.Windows.Forms.ComboBox();
      this.comBoxRedBitRate = new System.Windows.Forms.ComboBox();
      this.ckBoxVarBitRate = new System.Windows.Forms.CheckBox();
      ...
      this.panelSeriesDigits = new System.Windows.Forms.Panel();
      this.lblSeriesDigits = new System.Windows.Forms.Label();
      this.lblOutFolderConflict = new System.Windows.Forms.Label();
      ...
      this.lblPrefEmbChapTimes = new System.Windows.Forms.Label();
      ...
      this.pnlPrefEmbChapTim.SuspendLayout();
      ((System.ComponentModel.ISupportInitialize)(this.numUpDnSeriesDigits)).BeginInit();
      this.tabControl1.SuspendLayout();
      this.tabPage1.SuspendLayout();
      this.tabPage2.SuspendLayout();
      this.tableLayoutPanel2.SuspendLayout();
      this.panelSeries.SuspendLayout();
      this.panelSeriesDigits.SuspendLayout();
      ...
      this.tableLayoutPanel1.Controls.Add(this.ckBoxFfmpegVersCheck, 1, 1);
      this.tableLayoutPanel1.Controls.Add(this.lblFfmpegVersCheck, 0, 1);
      this.tableLayoutPanel1.Controls.Add(this.lblRegActCode, 0, 2);
      this.tableLayoutPanel1.Controls.Add(this.panelActCode, 1, 2);
      this.tableLayoutPanel1.Controls.Add(this.lblUsrActCode, 0, 3);
      this.tableLayoutPanel1.Controls.Add(this.btnUsrActCode, 1, 3);
      this.tableLayoutPanel1.Controls.Add(this.lblFileAssoc, 0, 4);
      this.tableLayoutPanel1.Controls.Add(this.ckBoxFileAssoc, 1, 4);
      this.tableLayoutPanel1.Controls.Add(this.lblDateClm, 0, 5);
      this.tableLayoutPanel1.Controls.Add(this.ckBoxDateClm, 1, 5);
      this.tableLayoutPanel1.Controls.Add(this.lblAaxCopy, 0, 6);
      this.tableLayoutPanel1.Controls.Add(this.panelAaxCopy, 1, 6);
      this.tableLayoutPanel1.Controls.Add(this.lblLaunchPlayer, 0, 7);
      ...
      // 
      // ckBoxFfmpegVersCheck
      // 
      resources.ApplyResources(this.ckBoxFfmpegVersCheck, "ckBoxFfmpegVersCheck");
      this.ckBoxFfmpegVersCheck.Name = "ckBoxFfmpegVersCheck";
      this.toolTip1.SetToolTip(this.ckBoxFfmpegVersCheck, resources.GetString("ckBoxFfmpegVersCheck.ToolTip"));
      this.ckBoxFfmpegVersCheck.UseVisualStyleBackColor = true;
      this.ckBoxFfmpegVersCheck.CheckedChanged += new System.EventHandler(this.ckBoxFfmpegVersCheck_CheckedChanged);
      // 
      // lblFfmpegVersCheck
      // 
      resources.ApplyResources(this.lblFfmpegVersCheck, "lblFfmpegVersCheck");
      this.lblFfmpegVersCheck.Name = "lblFfmpegVersCheck";
      this.toolTip1.SetToolTip(this.lblFfmpegVersCheck, resources.GetString("lblFfmpegVersCheck.ToolTip"));
      // 
      // lblRegActCode
      // 
      ...
      // lblDateClm
      // 
      resources.ApplyResources(this.lblDateClm, "lblDateClm");
      this.lblDateClm.Name = "lblDateClm";
      this.toolTip1.SetToolTip(this.lblDateClm, resources.GetString("lblDateClm.ToolTip"));
      // 
      // ckBoxDateClm
      // 
      resources.ApplyResources(this.ckBoxDateClm, "ckBoxDateClm");
      this.ckBoxDateClm.Name = "ckBoxDateClm";
      this.toolTip1.SetToolTip(this.ckBoxDateClm, resources.GetString("ckBoxDateClm.ToolTip"));
      this.ckBoxDateClm.UseVisualStyleBackColor = true;
      // 
      // lblAaxCopy
      // 
      ...
      this.comBoxNamedChapters.SelectedIndexChanged += new System.EventHandler(this.comBoxNamedChapters_SelectedIndexChanged);
      // 
      // lblFlatFolders
      // 
      ...
      // lblVarBitRate
      // 
      resources.ApplyResources(this.lblVarBitRate, "lblVarBitRate");
      this.lblVarBitRate.Name = "lblVarBitRate";
      this.toolTip1.SetToolTip(this.lblVarBitRate, resources.GetString("lblVarBitRate.ToolTip"));
      // 
      // lblRedBitRate
      // 
      resources.ApplyResources(this.lblRedBitRate, "lblRedBitRate");
      this.lblRedBitRate.Name = "lblRedBitRate";
      this.toolTip1.SetToolTip(this.lblRedBitRate, resources.GetString("lblRedBitRate.ToolTip"));
      // 
      // pnlPrefEmbChapTim
      // 
      resources.ApplyResources(this.pnlPrefEmbChapTim, "pnlPrefEmbChapTim");
      this.pnlPrefEmbChapTim.Controls.Add(this.comBoxPrefEmbChapTimes);
      this.pnlPrefEmbChapTim.Name = "pnlPrefEmbChapTim";
      this.toolTip1.SetToolTip(this.pnlPrefEmbChapTim, resources.GetString("pnlPrefEmbChapTim.ToolTip"));
      // 
      // comBoxPrefEmbChapTimes
      // 
      resources.ApplyResources(this.comBoxPrefEmbChapTimes, "comBoxPrefEmbChapTimes");
      this.comBoxPrefEmbChapTimes.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comBoxPrefEmbChapTimes.FormattingEnabled = true;
      this.comBoxPrefEmbChapTimes.Items.AddRange(new object[] {
            resources.GetString("comBoxPrefEmbChapTimes.Items"),
            resources.GetString("comBoxPrefEmbChapTimes.Items1"),
            resources.GetString("comBoxPrefEmbChapTimes.Items2")});
      this.comBoxPrefEmbChapTimes.Name = "comBoxPrefEmbChapTimes";
      this.toolTip1.SetToolTip(this.comBoxPrefEmbChapTimes, resources.GetString("comBoxPrefEmbChapTimes.ToolTip"));
      // 
      // comBoxOutFolderConflict
      // 
      resources.ApplyResources(this.comBoxOutFolderConflict, "comBoxOutFolderConflict");
      this.comBoxOutFolderConflict.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comBoxOutFolderConflict.FormattingEnabled = true;
      this.comBoxOutFolderConflict.Items.AddRange(new object[] {
            resources.GetString("comBoxOutFolderConflict.Items"),
            resources.GetString("comBoxOutFolderConflict.Items1"),
            resources.GetString("comBoxOutFolderConflict.Items2"),
            resources.GetString("comBoxOutFolderConflict.Items3")});
      ...
      this.ckBoxSeries.Name = "ckBoxSeries";
      this.toolTip1.SetToolTip(this.ckBoxSeries, resources.GetString("ckBoxSeries.ToolTip"));
      this.ckBoxSeries.UseVisualStyleBackColor = true;
      this.ckBoxSeries.CheckedChanged += new System.EventHandler(this.ckBoxSeries_CheckedChanged);
      // 
      // numUpDnSeriesDigits
      // 
      resources.ApplyResources(this.numUpDnSeriesDigits, "numUpDnSeriesDigits");
      this.numUpDnSeriesDigits.Maximum = new decimal(new int[] {
            3,
            0,
            0,
            0});
      this.numUpDnSeriesDigits.Name = "numUpDnSeriesDigits";
      this.toolTip1.SetToolTip(this.numUpDnSeriesDigits, resources.GetString("numUpDnSeriesDigits.ToolTip"));
      // 
      // ckBoxFullCaptionBookFolder
      // 
      resources.ApplyResources(this.ckBoxFullCaptionBookFolder, "ckBoxFullCaptionBookFolder");
      ...
      // comBoxArtist
      // 
      resources.ApplyResources(this.comBoxArtist, "comBoxArtist");
      this.comBoxArtist.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comBoxArtist.FormattingEnabled = true;
      this.comBoxArtist.Items.AddRange(new object[] {
            resources.GetString("comBoxArtist.Items"),
            resources.GetString("comBoxArtist.Items1"),
            resources.GetString("comBoxArtist.Items2"),
            resources.GetString("comBoxArtist.Items3")});
      this.comBoxArtist.Name = "comBoxArtist";
      this.toolTip1.SetToolTip(this.comBoxArtist, resources.GetString("comBoxArtist.ToolTip"));
      // 
      // comBoxAlbumArtist
      // 
      resources.ApplyResources(this.comBoxAlbumArtist, "comBoxAlbumArtist");
      this.comBoxAlbumArtist.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comBoxAlbumArtist.FormattingEnabled = true;
      this.comBoxAlbumArtist.Items.AddRange(new object[] {
            resources.GetString("comBoxAlbumArtist.Items"),
            resources.GetString("comBoxAlbumArtist.Items1"),
            resources.GetString("comBoxAlbumArtist.Items2"),
            resources.GetString("comBoxAlbumArtist.Items3")});
      this.comBoxAlbumArtist.Name = "comBoxAlbumArtist";
      this.toolTip1.SetToolTip(this.comBoxAlbumArtist, resources.GetString("comBoxAlbumArtist.ToolTip"));
      // 
      // comBoxComposer
      // 
      resources.ApplyResources(this.comBoxComposer, "comBoxComposer");
      this.comBoxComposer.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comBoxComposer.FormattingEnabled = true;
      this.comBoxComposer.Items.AddRange(new object[] {
            resources.GetString("comBoxComposer.Items"),
            resources.GetString("comBoxComposer.Items1"),
            resources.GetString("comBoxComposer.Items2"),
            resources.GetString("comBoxComposer.Items3")});
      this.comBoxComposer.Name = "comBoxComposer";
      this.toolTip1.SetToolTip(this.comBoxComposer, resources.GetString("comBoxComposer.ToolTip"));
      // 
      // comBoxConductor
      // 
      resources.ApplyResources(this.comBoxConductor, "comBoxConductor");
      this.comBoxConductor.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comBoxConductor.FormattingEnabled = true;
      this.comBoxConductor.Items.AddRange(new object[] {
            resources.GetString("comBoxConductor.Items"),
            resources.GetString("comBoxConductor.Items1"),
            resources.GetString("comBoxConductor.Items2"),
            resources.GetString("comBoxConductor.Items3")});
      this.comBoxConductor.Name = "comBoxConductor";
      this.toolTip1.SetToolTip(this.comBoxConductor, resources.GetString("comBoxConductor.ToolTip"));
      // 
      // comBoxRedBitRate
      // 
      resources.ApplyResources(this.comBoxRedBitRate, "comBoxRedBitRate");
      this.comBoxRedBitRate.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.comBoxRedBitRate.FormattingEnabled = true;
      this.comBoxRedBitRate.Items.AddRange(new object[] {
            resources.GetString("comBoxRedBitRate.Items")});
      this.comBoxRedBitRate.Name = "comBoxRedBitRate";
      this.toolTip1.SetToolTip(this.comBoxRedBitRate, resources.GetString("comBoxRedBitRate.ToolTip"));
      // 
      // ckBoxVarBitRate
      // 
      resources.ApplyResources(this.ckBoxVarBitRate, "ckBoxVarBitRate");
      this.ckBoxVarBitRate.Name = "ckBoxVarBitRate";
      this.toolTip1.SetToolTip(this.ckBoxVarBitRate, resources.GetString("ckBoxVarBitRate.ToolTip"));
      this.ckBoxVarBitRate.UseVisualStyleBackColor = true;
      // 
      // lblArtist
      // 
      resources.ApplyResources(this.lblArtist, "lblArtist");
      this.lblArtist.Name = "lblArtist";
      this.toolTip1.SetToolTip(this.lblArtist, resources.GetString("lblArtist.ToolTip"));
      // 
      // lblAlbumArtist
      // 
      resources.ApplyResources(this.lblAlbumArtist, "lblAlbumArtist");
      this.lblAlbumArtist.Name = "lblAlbumArtist";
      this.toolTip1.SetToolTip(this.lblAlbumArtist, resources.GetString("lblAlbumArtist.ToolTip"));
      // 
      // lblComposer
      // 
      resources.ApplyResources(this.lblComposer, "lblComposer");
      this.lblComposer.Name = "lblComposer";
      this.toolTip1.SetToolTip(this.lblComposer, resources.GetString("lblComposer.ToolTip"));
      // 
      // lblConductor
      // 
      resources.ApplyResources(this.lblConductor, "lblConductor");
      this.lblConductor.Name = "lblConductor";
      this.toolTip1.SetToolTip(this.lblConductor, resources.GetString("lblConductor.ToolTip"));
      // 
      // tabControl1
      // 
      ...
      this.tableLayoutPanel2.Controls.Add(this.lblSeries, 0, 1);
      this.tableLayoutPanel2.Controls.Add(this.panelSeries, 1, 1);
      this.tableLayoutPanel2.Controls.Add(this.lblFullCaptionBookFolder, 0, 2);
      this.tableLayoutPanel2.Controls.Add(this.ckBoxFullCaptionBookFolder, 1, 2);
      this.tableLayoutPanel2.Controls.Add(this.lblPartName, 0, 3);
      this.tableLayoutPanel2.Controls.Add(this.panelPartName, 1, 3);
      this.tableLayoutPanel2.Controls.Add(this.lblOutFolderConflict, 0, 4);
      this.tableLayoutPanel2.Controls.Add(this.comBoxOutFolderConflict, 1, 4);
      ...
      this.toolTip1.SetToolTip(this.lblSeries, resources.GetString("lblSeries.ToolTip"));
      // 
      // panelSeries
      // 
      resources.ApplyResources(this.panelSeries, "panelSeries");
      this.panelSeries.Controls.Add(this.ckBoxSeries);
      this.panelSeries.Controls.Add(this.panelSeriesDigits);
      this.panelSeries.Name = "panelSeries";
      this.toolTip1.SetToolTip(this.panelSeries, resources.GetString("panelSeries.ToolTip"));
      // 
      // panelSeriesDigits
      // 
      resources.ApplyResources(this.panelSeriesDigits, "panelSeriesDigits");
      this.panelSeriesDigits.Controls.Add(this.numUpDnSeriesDigits);
      this.panelSeriesDigits.Controls.Add(this.lblSeriesDigits);
      this.panelSeriesDigits.Name = "panelSeriesDigits";
      this.toolTip1.SetToolTip(this.panelSeriesDigits, resources.GetString("panelSeriesDigits.ToolTip"));
      // 
      // lblSeriesDigits
      // 
      resources.ApplyResources(this.lblSeriesDigits, "lblSeriesDigits");
      this.lblSeriesDigits.Name = "lblSeriesDigits";
      this.toolTip1.SetToolTip(this.lblSeriesDigits, resources.GetString("lblSeriesDigits.ToolTip"));
      // 
      // lblOutFolderConflict
      // 
      resources.ApplyResources(this.lblOutFolderConflict, "lblOutFolderConflict");
      this.lblOutFolderConflict.Name = "lblOutFolderConflict";
      this.toolTip1.SetToolTip(this.lblOutFolderConflict, resources.GetString("lblOutFolderConflict.ToolTip"));
      // 
      // tabPage3
      // 
      ...
      this.tableLayoutPanel3.Controls.Add(this.lblCustPart, 0, 0);
      this.tableLayoutPanel3.Controls.Add(this.txtBoxCustPart, 1, 0);
      this.tableLayoutPanel3.Controls.Add(this.lblCustTitleChars, 0, 1);
      this.tableLayoutPanel3.Controls.Add(this.txtBoxCustTitleChars, 1, 1);
      this.tableLayoutPanel3.Controls.Add(this.lblIntermedCopySingle, 0, 2);
      this.tableLayoutPanel3.Controls.Add(this.ckBoxIntermedCopySingle, 1, 2);
      this.tableLayoutPanel3.Controls.Add(this.lblFixAacEnc, 0, 3);
      this.tableLayoutPanel3.Controls.Add(this.comBoxFixAacEncoding, 1, 3);
      this.tableLayoutPanel3.Controls.Add(this.lblVarBitRate, 0, 4);
      this.tableLayoutPanel3.Controls.Add(this.ckBoxVarBitRate, 1, 4);
      this.tableLayoutPanel3.Controls.Add(this.lblRedBitRate, 0, 5);
      this.tableLayoutPanel3.Controls.Add(this.comBoxRedBitRate, 1, 5);
      this.tableLayoutPanel3.Controls.Add(this.lblM4B, 0, 6);
      this.tableLayoutPanel3.Controls.Add(this.comBoxM4B, 1, 6);
      this.tableLayoutPanel3.Controls.Add(this.lblLatin1, 0, 7);
      this.tableLayoutPanel3.Controls.Add(this.ckBoxLatin1, 1, 7);
      this.tableLayoutPanel3.Controls.Add(this.lblExtraMetaFiles, 0, 8);
      this.tableLayoutPanel3.Controls.Add(this.ckBoxExtraMetaFiles, 1, 8);
      ...
      this.tableLayoutPanel4.Controls.Add(this.lblNamedChapters, 0, 0);
      this.tableLayoutPanel4.Controls.Add(this.comBoxNamedChapters, 1, 0);
      this.tableLayoutPanel4.Controls.Add(this.lblShipShort, 0, 1);
      this.tableLayoutPanel4.Controls.Add(this.panelSkipShort, 1, 1);
      this.tableLayoutPanel4.Controls.Add(this.lblSkipVeryShort, 0, 2);
      this.tableLayoutPanel4.Controls.Add(this.panelSkipVeryShort, 1, 2);
      this.tableLayoutPanel4.Controls.Add(this.lblVerAdjChapters, 0, 3);
      this.tableLayoutPanel4.Controls.Add(this.comBoxVerAdjChapters, 1, 3);
      this.tableLayoutPanel4.Controls.Add(this.lblPrefEmbChapTimes, 0, 4);
      this.tableLayoutPanel4.Controls.Add(this.pnlPrefEmbChapTim, 1, 4);
      this.tableLayoutPanel4.Name = "tableLayoutPanel4";
      this.toolTip1.SetToolTip(this.tableLayoutPanel4, resources.GetString("tableLayoutPanel4.ToolTip"));
      // 
      // lblPrefEmbChapTimes
      // 
      resources.ApplyResources(this.lblPrefEmbChapTimes, "lblPrefEmbChapTimes");
      this.lblPrefEmbChapTimes.Name = "lblPrefEmbChapTimes";
      this.toolTip1.SetToolTip(this.lblPrefEmbChapTimes, resources.GetString("lblPrefEmbChapTimes.ToolTip"));
      // 
      // tabPage5
      // 
      ...
      this.tableLayoutPanel5.Controls.Add(this.lblArtist, 0, 0);
      this.tableLayoutPanel5.Controls.Add(this.comBoxArtist, 1, 0);
      this.tableLayoutPanel5.Controls.Add(this.lblAlbumArtist, 0, 1);
      this.tableLayoutPanel5.Controls.Add(this.comBoxAlbumArtist, 1, 1);
      this.tableLayoutPanel5.Controls.Add(this.lblComposer, 0, 2);
      this.tableLayoutPanel5.Controls.Add(this.comBoxComposer, 1, 2);
      this.tableLayoutPanel5.Controls.Add(this.lblConductor, 0, 3);
      this.tableLayoutPanel5.Controls.Add(this.comBoxConductor, 1, 3);
      ...
      this.pnlPrefEmbChapTim.ResumeLayout(false);
      ((System.ComponentModel.ISupportInitialize)(this.numUpDnSeriesDigits)).EndInit();
      this.tabControl1.ResumeLayout(false);
      this.tabPage1.ResumeLayout(false);
      this.tabPage2.ResumeLayout(false);
      this.tableLayoutPanel2.ResumeLayout(false);
      this.panelSeries.ResumeLayout(false);
      this.panelSeriesDigits.ResumeLayout(false);
    ...
    private System.Windows.Forms.CheckBox ckBoxFfmpegVersCheck;
    private System.Windows.Forms.Label lblFfmpegVersCheck;
    private System.Windows.Forms.TabPage tabPage4;
    private System.Windows.Forms.TableLayoutPanel tableLayoutPanel4;
    private System.Windows.Forms.Label lblVarBitRate;
    private System.Windows.Forms.Label lblRedBitRate;
    private System.Windows.Forms.ComboBox comBoxOutFolderConflict;
    private System.Windows.Forms.CheckBox ckBoxVarBitRate;
    private System.Windows.Forms.Label lblPrefEmbChapTimes;
    private System.Windows.Forms.ComboBox comBoxPrefEmbChapTimes;
    private System.Windows.Forms.Panel pnlPrefEmbChapTim;
    private System.Windows.Forms.TabPage tabPage5;
    private System.Windows.Forms.TableLayoutPanel tableLayoutPanel5;
    private System.Windows.Forms.Label lblArtist;
    private System.Windows.Forms.ComboBox comBoxArtist;
    ...
    private System.Windows.Forms.ComboBox comBoxAlbumArtist;
    private System.Windows.Forms.ComboBox comBoxComposer;
    private System.Windows.Forms.ComboBox comBoxConductor;
    private System.Windows.Forms.Label lblDateClm;
    private System.Windows.Forms.CheckBox ckBoxDateClm;
    private System.Windows.Forms.Label lblSeries;
    private System.Windows.Forms.Label lblFullCaptionBookFolder;
    private System.Windows.Forms.Panel panelSeries;
    private System.Windows.Forms.NumericUpDown numUpDnSeriesDigits;
    private System.Windows.Forms.CheckBox ckBoxSeries;
    private System.Windows.Forms.Label lblSeriesDigits;
    private System.Windows.Forms.CheckBox ckBoxFullCaptionBookFolder;
    private System.Windows.Forms.Label lblOutFolderConflict;
