namespace audiamus.aaxconv {
  partial class MainForm {
    ...
    private void InitializeComponent () {
      ...
      this.radBtnM4a = new System.Windows.Forms.RadioButton();
      ...
      this.grpBoxMode.Controls.Add(this.lblTraclLen);
      this.grpBoxMode.Controls.Add(this.lblDuration);
      this.grpBoxMode.Controls.Add(this.numUpDnTrkLen);
      ...
      this.grpBoxFormat.Controls.Add(this.radBtnM4a);
      ...
      // radBtnM4a
      // 
      resources.ApplyResources(this.radBtnM4a, "radBtnM4a");
      this.radBtnM4a.Name = "radBtnM4a";
      this.radBtnM4a.TabStop = true;
      this.toolTip1.SetToolTip(this.radBtnM4a, resources.GetString("radBtnM4a.ToolTip"));
      this.radBtnM4a.UseVisualStyleBackColor = true;
      this.radBtnM4a.CheckedChanged += new System.EventHandler(this.radBtnM4A_CheckedChanged);
      // 
      // radBtnMp3
      // 
    ...
    private System.Windows.Forms.RadioButton radBtnM4a;
